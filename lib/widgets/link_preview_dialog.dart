                  ...
                  child: Column(
                    ...
                    children: [
                      AspectRatio(
                        aspectRatio: 1.91,
                        child:
                            link.ogImageUrl != null &&
                                link.ogImageUrl!.isNotEmpty
                            ? Image.network(
                                link.ogImageUrl!,
                                fit: BoxFit.cover,
                                loadingBuilder:
                                ...
                                Expanded(
                                  child: TextButton.icon(
                                    ...
                                    style: TextButton.styleFrom(
                                      ...
                                      backgroundColor: kSwipeReadColor
                                          .withValues(alpha: 0.12),
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(10),
                                        side: BorderSide(
                                          color: kSwipeReadColor.withValues(
                                            alpha: 0.25,
                                          ),
                                          width: 0.5,
                                        ),
      ...
      child: Center(
        child: Stack(
          ...
          children: [
            Opacity(
              opacity: 0.05,
              child: Icon(Icons.link, size: 80, color: cs.onSurface),
            ),
            Column(
